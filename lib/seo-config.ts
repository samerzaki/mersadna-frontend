...
export const SEO_CONFIG = {
  site: {
    ...
    nameAr: 'قدامك',
    domain: SITE_URL,
    description: 'قدامك منصة عربية لمتابعة أسعار الذهب والعملات والمعادن في مصر.',
  },
  verification: {
  ...
  pages: {
    home: { title: 'قدامك | أسعار الذهب والعملات في مصر', description: 'تابع أسعار الذهب والعملات والفضة في مصر، مع تحديثات السوق وأدوات حسابية واضحة.' },
    ...
    news: { title: 'أخبار الذهب والاقتصاد', description: 'أحدث أخبار الذهب والعملات والاقتصاد التي يكتبها فريق قدامك.' },
    about: { title: 'عن قدامك', description: 'تعرف على منصة قدامك لمتابعة الأسواق المصرية.' },
    contact: { title: 'اتصل بقدامك', description: 'تواصل مع فريق قدامك للاستفسارات والمقترحات.' },
    privacy: { title: 'سياسة الخصوصية', description: 'سياسة خصوصية منصة قدامك.' },
    terms: { title: 'شروط الاستخدام', description: 'شروط استخدام منصة قدامك.' },
    ...
    authLogin: { title: 'تسجيل الدخول', description: 'سجل دخولك إلى حسابك في قدامك.' },
    authRegister: { title: 'إنشاء حساب', description: 'أنشئ حسابك في قدامك.' },
