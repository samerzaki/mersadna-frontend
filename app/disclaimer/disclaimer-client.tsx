...
function EnglishContent() {
  return <>
    <p><strong className="text-foreground">Odamak</strong> operates as an independent platform for monitoring, aggregating, and displaying prices, data, and information available in the markets, including prices for <strong className="text-foreground">gold, silver, metals, currencies, bank rates, digital currencies, and other assets and indices</strong> followed by the website.</p>
    <p><strong className="text-foreground">Odamak is not a pricing authority, bank, exchange, financial intermediary, or a party that sells or purchases any of the displayed assets.</strong> The prices published on the website are monitored and aggregated from the market and multiple sources and data sets, and are displayed for informational and guidance purposes only.</p>
    <p>The prices displayed on Odamak may differ from the <strong className="text-foreground">actual purchase, sale, or execution price</strong> offered by banks, goldsmiths, merchants, exchanges, trading platforms, or other parties. Prices may also change quickly, and some data may be delayed or updated incorrectly.</p>
    <p>Accordingly, <strong className="text-foreground">Odamak does not guarantee the accuracy, completeness, or timeliness of prices and data at all times, and they should not be relied upon alone when carrying out any transaction or making any financial or investment decision.</strong> You are always advised to verify the final price directly with the party with whom you intend to transact.</p>
    ...
    <p><strong className="text-foreground">Your use of Odamak means that you understand that the website is a tool for monitoring and following the market, not a binding pricing source or a party for executing transactions, and that any decision or transaction is made at your own responsibility.</strong></p>
  </>;
}
